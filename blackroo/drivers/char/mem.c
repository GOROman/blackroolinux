...
int __init chr_dev_init(void)
{
	...
	/* BLACKROO: gated, because on 2 MB each of these is measured against
	 * what it can be used for. /dev/random is simply absent rather than
	 * stubbed - a predictable /dev/random is worse than none. See docs/28. */
#ifdef CONFIG_DEV_RANDOM
	rand_initialize();
#endif
