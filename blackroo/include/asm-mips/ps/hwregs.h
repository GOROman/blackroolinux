...
/*
 * Memory size configuration register (0x1F801060)
 *
 * Bits 9-11 control RAM bank size:
 *   0b100 (0x0888) = 2MB on /RAS0 (stock PlayStation)
 *   0b001 (0x0988) = 4MB on /RAS0 (4MB upgrade)
 *   0b101 (0x0B88) = 8MB on /RAS0 (8MB mod)
 *
 * Bit 3 must be 1 (crashes if 0 on most board revisions)
 * Bit 7 is CODE+DATA fetch delay
 * Bit 8 must be set for 8MB, cleared for <=4MB
 *
 * Reference: psx-spx Memory Control (https://psx-spx.consoledev.net/memorycontrol/)
 */
#define MEM_SIZE_PORT       0x1060
#define MEM_SIZE_REG_2MB    0x0888  /* bits 9-11 = 100 */
#define MEM_SIZE_REG_4MB    0x0988  /* bits 9-11 = 001 */
#define MEM_SIZE_REG_8MB    0x0B88  /* bits 9-11 = 101, bit 8 set */
