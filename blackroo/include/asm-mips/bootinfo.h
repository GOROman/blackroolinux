...
/* BLACKROO: PlayStation support */
#define MACH_GROUP_PSX 99
#define MACH_GROUP_PS  MACH_GROUP_PSX
#define MACH_PSX       0
...
#ifndef _LANGUAGE_ASSEMBLY
extern void add_memory_region(unsigned long start, unsigned long size, long type);
#endif
